...
var App = _react2['default'].createClass({
  ...
  _globalTextChanged: function _globalTextChanged(data) {
    this.setState({ value: data.value });
  },

  _guestTextChanged: function _guestTextChanged(data) {
    console.log('data', data);
    var userValues = this.state.userValues;
  ...
  renderUserList: function renderUserList(users) {
    ...
    return users.map(function (user) {
      ...
      var userValues = _this.state.userValues[user];
      if (userValues) {
  ...
  handleChange: function handleChange(event) {
    ...
    var accuracy = this.accuracy(value, this.state.dash);
...
},{"./tests.json":2,"react":158}],2:[function(require,module,exports){
module.exports={
  "test1": "You'll sip the syrup and shaved ice. You'll taste beans and rice.",
  "test2": "Fly you fools!"
}
